...
class Wave1 extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    var firstControlPoin = Offset(size.width * 0.25, size.height - 60 - 50);

    path.quadraticBezierTo(firstControlPoin.dx, firstControlPoin.dy,
...
class Wave2 extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    var firstControlPoin = Offset(size.width * 0.25, size.height);
...
class Login7 extends StatefulWidget {
  ...
  @override
  State<Login7> createState() => _Login7();
}

class _Login7 extends State<Login7> {
  @override
...
// void main() {
//   runApp(MaterialApp(home: Login7()));
// }
